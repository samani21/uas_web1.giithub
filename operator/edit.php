<?php
    ...
    $id = $_GET['npm'];
    $ambil = mysqli_query($koneksi,"SELECT * FROM tb_mahasiswa WHERE npm='$id'");
...
<html>
    ...
    <body>
        ...
        <div class="card-header bg-dark text-white">
            <h1 align="right">EDIT DATA MAHASISWA</h1>
        ...
        <div class="card-body">
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="npm" placeholder="Masukkan NPM" value="<?php echo $data['npm'];?>" readonly>
                </div>
                <div class="form-group">
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($koneksi,"UPDATE  tb_mahasiswa SET nama='$nama',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',alamat='$alamat',kode_pos='$kode_pos' WHERE npm='$id'") or die (mysqli_error($koneksi));
