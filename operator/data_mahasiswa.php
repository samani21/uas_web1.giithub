...
<html>
    ...
    <body>
        ...
        <div class="card-header bg-dark text-white">
            <h1 align="right">INPUT DATA MAHASISWA</h1>
                ...
                <tbody>
                    ...
                    ?>
                        <tr align="center">
                            ...
                            <td width="120"><a href="edit.php?npm=<?php echo $data['npm'];?>">
                            <button type="button" class="btn btn-warning"><img src="../asset/pencil-square.svg" width="17" height="17" class="d-inline-block align-top" alt="">Edit</button>
                            <td width="120"><a href="hapus.php?npm=<?php echo $data['npm'];?>">
                            <button type="button" class="btn btn-danger"><img src="../asset/trash-fill.svg" width="17" height="17" class="d-inline-block align-top" alt="">Hapus</button>
                            </td>
                        </tr>
                    <?php
                        }
